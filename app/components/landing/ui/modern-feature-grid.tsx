...
export const FeatureGrid = React.forwardRef<HTMLElement, FeatureGridProps>(
  ({ sectionTitle, sectionDescription, features = [], className, id, ...props }, ref) => {
    const titleId = React.useId();

    return (
      <section ref={ref} id={id} className={cn('w-full py-12', className)} aria-labelledby={titleId} {...props}>
