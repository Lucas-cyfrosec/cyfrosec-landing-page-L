...
const fsSource = `
  ...
  const vec4 lineColor = vec4(0.01, 0.61, 0.88, 1.0);
  ...
  void main() {
    ...
    float verticalFade = smoothstep(0.35, 0.65, 1.0 - uv.y);

    space.y += random(space.x * warpFrequency + iTime * warpSpeed) * warpAmplitude * (0.5 + horizontalFade);
    space.x += random(space.y * warpFrequency + iTime * warpSpeed + 2.0) * warpAmplitude * horizontalFade;

    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.047, 0.110, 0.165, 1.0);
    vec4 bgColor2 = vec4(0.059, 0.141, 0.212, 1.0);
