...
export const metadata = {
  title: 'Notifications | CyfroSec Documentation',
  description: 'Understanding CyfroSec notifications — toasts, notification history, filtering, and session-scoped state.',
  alternates: { canonical: '/documents/notifications' },
}
    ...
    <div className="flex gap-0 w-full max-w-[1600px] mx-auto">
      ...
      <article className="flex-1 min-w-0 px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-8 lg:py-10 w-full max-w-5xl mx-auto">
        ...
        <p className="cy-text-secondary leading-relaxed mb-10" id="overview">
          CyfroSec delivers real-time security notifications as events happen across your infrastructure - scans
          completing, vulnerabilities detected, assets discovered, and more. Notifications arrive instantly via a
          live connection to the platform without needing to refresh the page.
        </p>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b cy-border-default">
                  <th className="text-left py-2 pr-4 text-xs font-bold uppercase tracking-wider cy-text-muted">State</th>
                  <th className="text-left py-2 pr-4 text-xs font-bold uppercase tracking-wider cy-text-muted">Appearance</th>
                </tr>
              </thead>
              <tbody>
                {[
