...
const CAPABILITY_ICONS = [Github, Code2, Layers, ScanLine, Filter, Sparkles, GitPullRequest, AlertTriangle, Code2]
  ...
  return (
    <PublicPageShell>
      ...
      <section className="bg-white dark:bg-surface-900 py-20 px-4">
        <div className="mx-auto max-w-5xl grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-primary-400 mb-3">{labels.findingsLabel}</p>
            <h2 className="text-2xl font-bold cy-text-primary sm:text-3xl mb-5" style={{ fontFamily: HEADING_FONT }}>
              {pg.findingsTitle}
            </h2>
            <p className="text-sm cy-text-secondary leading-relaxed mb-4">{pg.findingsP1}</p>
            <p className="text-sm cy-text-secondary leading-relaxed">{pg.findingsP2}</p>
          </div>
          <div className="space-y-4">
